...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Skills-111-success.svg" alt="111 Skills">
...
- **Repo structure plus CI.** Every plugin manifest validates. CI runs `validate.py` on every push to catch structural drift. Locally, `python scripts/eval.py` runs 1,882 fact-pattern assertions across 111 skills (111/111 passing).
...
<p align="center">
  <strong>49 areas · 111 skills · 3 LLM providers · Researcher then Drafter then Reviewer · DSGVO / KI-VO / NIS2 / HinSchG / LkSG / DORA / DSA / CSRD scaffolding</strong><br>
